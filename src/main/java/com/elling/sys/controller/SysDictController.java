...
public class SysDictController {
    ...
    public Result add(@RequestBody SysDict sysDict) {
    	try {
    		sysDict.setCreateTime(DateUtil.getNowTime());
    ...
    public Result update(@RequestBody SysDict sysDict) {
    	try {
    		sysDict.setUpdateTime(DateUtil.getNowTime());
    ...
    public Result detail(Long id) {
        ...
        try {
	        sysDict = sysDictService.findById(id);
	    }catch(Exception e) {
    		e.printStackTrace();
    		logger.error(e.getMessage());
    		return Result.error(e.getMessage());
    ...
    public Result getByColumn(@RequestParam String colomnName, @RequestParam String colomnVal) {
        try{
	        SysDict sysDict = sysDictService.findBy(colomnName, colomnVal);
	        return Result.success(sysDict);
        }catch(Exception e){
        	return Result.error(e.getMessage());
        }
