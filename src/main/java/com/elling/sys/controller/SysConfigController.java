...
public class SysConfigController {
    ...
    public Result detail(Long id) {
        ...
        try {
	        sysConfig = sysConfigService.findById(id);
	    }catch(Exception e) {
    		e.printStackTrace();
    		logger.error(e.getMessage());
    		return Result.error(e.getMessage());
    ...
    public Result getByColumn(@RequestParam String colomnName, @RequestParam String colomnVal) {
        try{
	        SysConfig sysConfig = sysConfigService.findBy(colomnName, colomnVal);
	        return Result.success(sysConfig);
        }catch(Exception e){
        	return Result.error(e.getMessage());
        }
    ...
    public Result getByExample(@RequestBody Map map) {
    	try {
    		...
    		PageHelper.startPage(page, size);
    		List<SysConfig> list = sysConfigService.findByCondition(condition);
