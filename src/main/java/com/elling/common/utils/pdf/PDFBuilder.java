...
public class PDFBuilder extends PdfPageEventHelper {
	...
	/**
	 * * * @param header * @param presentFontSize * @param pageSize * @param
	 * watermark
	 */
	...
	/**
	 * * * @描述：分页 * * @返回：void * * @作者：zhongjy * * @时间：2019年7月15日 下午9:09:39
	 */
...
//	   log.error("", e);
	...
	/**
	 * * * @描述：添加水印 * * @返回：void * * @作者：zhongjy * * @时间：2019年7月15日 下午9:12:40
	 */
	...
	public void addWatermark(PdfWriter writer) {
		...
		Image image = null;
		try {
			image = null;//Image.getInstance(BaseUtil.file2byte(watermark));
